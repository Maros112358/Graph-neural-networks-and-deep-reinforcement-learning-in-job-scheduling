...
def main():
    ...
    env_paras = copy.deepcopy(env_paras)
    num_ins = test_paras["num_ins"]
    if test_paras["sample"]:
        env_paras["batch_size"] = test_paras["num_sample"]
    else:
            ...
            # Create environment object
                ...
                if test_paras["sample"]:
                    env = gym.make('fjsp-v0', case=[test_file] * test_paras["num_sample"],
                                   env_paras=env_paras, data_source='file')
                # DRL-G, each env contains one instance
                else:
                    print([test_file], env_paras)
                    env = gym.make('fjsp-v0', case=[test_file], env_paras=env_paras, data_source='file')
...
if __name__ == '__main__':
    ...
    test_files = [
        "./data_test/Public/Mk01.fjs",
        "./data_test/Public/Mk02.fjs",
        "./data_test/Public/Mk03.fjs",
        "./data_test/Public/Mk04.fjs",
        "./data_test/Public/Mk05.fjs",
        "./data_test/Public/Mk06.fjs",
        "./data_test/Public/Mk07.fjs",
        "./data_test/Public/Mk08.fjs",
        "./data_test/Public/Mk09.fjs",
        "./data_test/Public/Mk10.fjs"
    ]
    for file in test_files:
        ...
        env_paras["num_jobs"] = ins_num_jobs
        env_paras["num_mas"] = ins_num_mas
        env = gym.make('fjsp-v0', case=[file], env_paras=env_paras, data_source='file')
        print(schedule(env, model, memories))
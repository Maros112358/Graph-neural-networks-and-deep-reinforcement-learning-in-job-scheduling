...
if __name__ == '__main__':
    DATA_FILE = 'experiment_static_fjsp_fjsp_drl.csv'
    PREV_DATA_FILE = 'experiment_static_fjsp_fjsp_drl_prev.csv'
    exceptions = [
    ...
    for model_path in models:
        ...
        for instance in instances:      
            if instance in exceptions:
                logging.info("Skipping {}".format(instance))  
                continue
            ...
            for seed in seeds:
                ...
                if not filtered_df.empty:
                    ...
                    # load instance
                    fjsp_instance = shuffle_file_rows(instance, seed=seed)

...
if __name__ == '__main__':
    DATA_FILE = 'experiment_static_jssp_end_to_end_drl_for_fjsp.csv'
    exceptions = [
    ...
    for model in models:
        for instance in instances:
            ...
            if instance in exceptions:
                logging.warning(f'Skipping {instance}')
                continue

            for seed in seeds:
                # run experiment
                makespan, _, _, runtime = solve_fjsp_instance(model, jssp_taillard_to_fjsp(instance, seed=seed))

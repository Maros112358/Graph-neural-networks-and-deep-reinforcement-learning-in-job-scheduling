...
for filename in os.listdir(directory):
    if filename.startswith("experiment_static_fjsp_") and filename.endswith(".csv"):
        ...
        if 'model' in df.columns:
            ...
            df['model'] = filename.removeprefix("experiment_static_fjsp_").removesuffix('.csv')
...
details_df = pd.read_csv('../../fjsp_details.csv')
...
final_updated_df.to_csv('fjsp_preprocess_data.csv', index=False)

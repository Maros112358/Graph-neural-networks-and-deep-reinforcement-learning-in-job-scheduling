...
To test the null hypothesis that the median values of all models and PDRs over all JSSP benchmark instances are from the same population, we used the Kruskal-Wallis test \cite{doi:10.1080/01621459.1952.10483441}. The p-value for this null hypothesis was $p < 5\%$, so we rejected this null hypothesis.
\par
